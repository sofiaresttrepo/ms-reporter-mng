...
class ReportDA {
   ...
   */
  static getReport$(id, organizationId) {
  ...
  static getReportList$(filter = {}, pagination = {}, sortInput) {
    const collection = mongoDB.db.collection(CollectionName);
  ...
  * @param {*} id Report ID
  * @param {*} Report properties
  */
  static createReport$(_id, properties, createdBy) {
  ...
  /**
  * modifies the Report properties
  * @param {String} id  Report ID
  * @param {*} Report properties to update
  */
  static updateReport$(_id, properties, updatedBy) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  * @param {*} Report properties to update
  */
  static updateReportFromRecovery$(_id, properties, av) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  * @param {*} Report properties to update
  */
  static replaceReport$(_id, properties) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  */
  ...
  /**
    * deletes multiple Report at once
    * @param {*} _ids  Report IDs array
  */
  static deleteReports$(_ids) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
